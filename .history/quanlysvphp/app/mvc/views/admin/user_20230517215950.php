        ...
        $(document).on('click', '#updateButton', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    newRow.find('#newId').
newRow.find('#newName').text(id)newRow.find('#newPassword').text(id)newRow.find('.select-usertype').text(id)newRow.find('.select-status').text(id)newRow.find('.mssv-select').text(id)newRow.find('.magv-select').text(id)                },
                error: function(xhr, status, error) {
                    // Xử lý lỗi khi gửi yêu cầu AJAX
                    console.error(xhr.responseText);
                }
